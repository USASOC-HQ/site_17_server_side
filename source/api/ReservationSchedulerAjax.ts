 namespace x_g_inte_site_17 {
    export interface IReservationSchedulerAjax extends $$snClass.ICustomClassBase<IReservationSchedulerAjax, "ReservationSchedulerAjax"> {
        /**
    ...
    export interface IReservationSchedulerAjaxPrototype extends $$snClass.ICustomAjaxClassPrototype<IReservationSchedulerAjax, IReservationSchedulerAjaxPrototype, "ReservationSchedulerAjax">, IReservationSchedulerAjax {
        _scheduler?: ReservationScheduler;
    }

    export declare type ReservationSchedulerAjax = Readonly<IReservationSchedulerAjax>;

    export interface ReservationSchedulerAjaxConstructor extends $$snClass.CustomAjaxClassConstructor<IReservationSchedulerAjax, IReservationSchedulerAjaxPrototype, ReservationSchedulerAjax> {
    ...
    export const ReservationSchedulerAjax: ReservationSchedulerAjaxConstructor = (function (): ReservationSchedulerAjaxConstructor {
        var constructor: ReservationSchedulerAjaxConstructor = Class.create();
         ...
         * @type {string}
         */
        const XMLNAME_scheduler_type = "scheduler_type";
         ...
         * @type {string}
         */
        const INCLUDE_NAME_durations = "durations";
        ...
        function addIncludeParams(this: IAbstractAjaxProcessor, scheduler: x_g_inte_site_17.ReservationScheduler) :string[] {
            ...
            if (arrayUtil.contains(include, INCLUDE_NAME_groups)) {
                ...
                if (arrayUtil.contains(include, INCLUDE_NAME.approval_group) && typeof scheduler.approval_group !== 'undefined') {
                    if (typeof element === 'undefined') element = this.newItem(XMLNAME_scheduler_type);
                    result.push(INCLUDE_NAME.approval_group);
                    element.setAttribute(INCLUDE_NAME.approval_group, scheduler.approval_group);
                }
        ...
        function getNextAvailableTimeSlot(this: IAbstractAjaxProcessor, scheduler: ReservationScheduler): string[] {
            ...
            var availabilitiesElement: IXMLElement = this.newItem(XMLNAME_availability);
         ...
         * start_time_interval = The number of minutes for start time intervals will be contained in the 'start_time_interval' attribute of the 'scheduler_type' element.
         */
        constructor.getNextAvailableTimeSlot = function(processor: IAbstractAjaxProcessor, scheduler: ReservationScheduler): string[]
        {
         ...
         * start_time_interval = The number of minutes for start time intervals will be contained in the 'start_time_interval' attribute of the 'scheduler_type' element.
         */
        constructor.getAvailabilitiesInRange = function(processor: IAbstractAjaxProcessor, scheduler: ReservationScheduler): string[]
        {
            if (typeof processor === 'undefined') throw new Error("AJAX processor not provided.");
            if (typeof scheduler === 'undefined') throw new Error("Scheduler not provided.");
