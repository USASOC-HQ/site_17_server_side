...
(function (site17Util_FirstIteratedTest) {
    (function (outputs, steps, stepResult, assertEqual) {
        ...
        stepResult.setOutputMessage("Executing " + pseudoCode);
        try {
            returnValue = x_g_inte_site_17.Site17Util.firstIterated(source, predicate1, thisArg);
        }
        catch (e) {
            atfHelper.setFailed('Unexpected exception while invoking ' + pseudoCode, e);
            return false;
        ...
        stepResult.setOutputMessage("Executing " + pseudoCode);
        try {
            returnValue = x_g_inte_site_17.Site17Util.firstIterated(source, predicate2, thisArg);
        }
        catch (e) {
            atfHelper.setFailed('Unexpected exception while invoking ' + pseudoCode, e);
            return false;
...
(function (site17Util_firstIteratedOrDefault) {
    (function (outputs, steps, stepResult, assertEqual) {
        ...
        stepResult.setOutputMessage("Executing " + pseudoCode);
        try {
            returnValue = x_g_inte_site_17.Site17Util.firstIteratedOrDefault(source, ifEmptyValue, predicate1, thisArg);
        }
        catch (e) {
            atfHelper.setFailed('Unexpected exception while invoking ' + pseudoCode, e);
            return false;
        ...
        stepResult.setOutputMessage("Executing " + pseudoCode);
        try {
            returnValue = x_g_inte_site_17.Site17Util.firstIteratedOrDefault(source, ifEmptyValue, predicate2, thisArg);
        }
        catch (e) {
            atfHelper.setFailed('Unexpected exception while invoking ' + pseudoCode, e);
            return false;
        ...
        stepResult.setOutputMessage("Executing " + pseudoCode);
        try {
            returnValue = x_g_inte_site_17.Site17Util.firstIteratedOrDefault(source, ifEmptyFunc, predicate1, thisArg);
        }
        catch (e) {
            atfHelper.setFailed('Unexpected exception while invoking ' + pseudoCode, e);
            return false;
